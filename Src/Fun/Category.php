...
use Coincity\SDK\Fun\Attr\AttributesCategory;
...
class Category extends Models implements IModel, IParser
{
    /**
     * @var AttributesCategory
     */
    public AttributesCategory $attributes;
    /**
     * @var string|null
     */
    static public ?string $class_name = Category::class;
    /**
     * @var string|null
     */
    static public ?string $api_uri = "category";
    ...
    {
        $this->attributes = new AttributesCategory();
    }
