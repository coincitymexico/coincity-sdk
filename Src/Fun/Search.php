...
use Coincity\SDK\Fun\Attr\AttributesSearch;
...
class Search extends Models implements IModel, IParser
{
    /**
     * @var AttributesSearch
     */
    public AttributesSearch $attributes;
    /**
     * @var string|null
     */
    static public ?string $class_name = Search::class;
    /**
     * @var string|null
     */
    static public ?string $api_uri = "search";
    ...
    {
        $this->attributes = new AttributesSearch();
    }
