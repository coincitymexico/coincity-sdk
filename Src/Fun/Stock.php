...
use Coincity\SDK\Fun\Attr\AttributesStock;
...
class Stock extends Models implements IModel, IParser
{
    /**
     * @var AttributesStock
     */
    public AttributesStock $attributes;
    /**
     * @var string|null
     */
    static public ?string $class_name = Stock::class;
    /**
     * @var string|null
     */
    static public ?string $api_uri = "sae-stock";
    ...
    {
        $this->attributes = new AttributesStock();
    }
